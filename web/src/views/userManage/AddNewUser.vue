        ...
        <div class="bottom">
            <div class="row1">
                ...
                <div class="material-name clearfix" style="margin-top:20px;">
                    ...
                    <span class="material-name-right fl">
                        <el-select v-model="addNewUser['role-id']" placeholder="请选择角色" style="min-width:513px;">
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            this.$esellApi.send("/user/add.shtml", this.addNewUser, res => {
                console.log(this.addNewUser)
                if (res.message == "OK") {
                ...
                console.log("进入了错误请求", res);
                if (res.message == "用户账号不能为空" || res.message == "用户密码不能为空" || res.message == "角色不能为空") {
                    this.message("error", res.message, () => { })
                } else if (res.message == "要求先登录") {
