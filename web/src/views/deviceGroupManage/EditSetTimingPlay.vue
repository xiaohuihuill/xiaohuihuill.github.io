    ...
    <div class="new-set-timing-play">
        <div class="top clearfix">
            ...
            <span class="crumbs fl">
                ...
                <span>></span>
                <router-link to="/devgroup_mag/examine_play_list" class="blue">播放列表</router-link>
                <span>></span>
                <router-link to="/devgroup_mag/play_list/set_timing_play" class="blue">设置定时播放</router-link>
                <span>></span>
                <span>编辑定时播放时间</span>
            </span>
        </div>
                ...
                <div class="cycle-period">
                        ...
                        <div>
                            <div style="height:30px;line-height:30px;" class="clearfix">
                                ...
                                <div class="fl everyday-start-time-input" style="height:34px;width:60%;">
                                    <el-time-select style="width:100%;" v-model="value1" :picker-options="{start: '08:30',step: '00:15',end: '18:30'}" placeholder="请选择开始时间">
                                    </el-time-select>
                                </div>
                            </div>
                            <div style="height:30px;line-height:30px;margin-top:20px;width:100%;" class="clearfix">
                                ...
                                <div class="fl clearfix" style="height:30px;">
                                    ...
                                    <div class="fl cleafix" style="margin-left:30px;">
                                        <div class="fl everyday-end-time-play-title" style="margin-right:6px;">
                                            <el-radio class="radio" v-model="radio22" label="2">播放</el-radio>
                                        </div>
                                        <div class="fl everyday-end-time-play-title-input" style="width:45%">
                                            <el-input v-model="input" placeholder="请输入播放次数"></el-input>
                                        </div>
                                        <div class="fl">&nbsp;次结束</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div v-show="isShow==2" class="someday" style="margin:20px 0 20px;">
                        <div style="height:30px;line-height:30px">
                            ...
                            <div style="width:100%;">
                                <el-date-picker style="width:60%;" v-model="value1" type="date" placeholder="选择日期" :picker-options="pickerOptions0">
                                </el-date-picker>
                            </div>
                        </div>
