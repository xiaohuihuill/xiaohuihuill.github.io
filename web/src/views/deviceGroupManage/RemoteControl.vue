    ...
    <div class="remote-control">
        <div class="top clearfix">
            ...
            <span class="crumbs fl">
                ...
                <span>></span>
                <router-link to="/dev_mag" class="blue">设备组管理</router-link>
                <span>></span>
                <span>远程控制</span>
            </span>
        </div>
                ...
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    ...
                    <el-tab-pane label="基本控制" name="first">
                        ...
                        <div style="margin-top:20px;">
                            ...
                            <a href="javascript:;" class="yxf-but" data-butflag="1522750334890" @click="basicControlSubmit">提 交</a>
                        </div>
                    </el-tab-pane>
                    <!--定时开关机页面-->
                    <el-tab-pane label="定时开关机" name="second">
                        <div style="margin-top:5px;" data-butflag="1522750375937">
                            <div>
                                ...
                                <el-table-column label="操作" width='80'>
                                    <template slot-scope="scope">
                                        <div class="file-operation-other clearfix">
                                            ...
                                            <a class="blue delete1 fl" data-butflag="1522750419801" @click="delete1(scope.row)">删除</a>
                                        </div>
                                    </template>
                                </el-table-column>
                            </el-table>
                        ...
                        <div style="margin-top:20px;">
                            <a href="javascript:;" class="yxf-but" data-butflag="1522750446082" @click="saveCommit">保存设置</a>
                        </div>
                    </el-tab-pane>
                </el-tabs>
            </div>
...
export default {
    ...
    methods: {
        ...
        getDeviceRemoteControl() {
            this.$esellApi.send("/group/attrbute/get.shtml", {
                ...
                if (res.payload == undefined) {
                    ...
                    if (res.payload['action-type'] == undefined) {
                        this.timeSwitchType = "everyday";
                        this.radio = "everyday";
                        console.log(1, this.timeSwitchType)
                    } else {
                    ...
                    console.log(2, this.timeSwitchType)
        ...
        getDeviceRemoteControlSwitchList(type) {
            this.$esellApi.send("/group/timer/list.shtml", {
        ...
        // 基本设置属性的保存提交
        basicControlSubmit() {
            console.log(1111, this.basicControl);
            console.log(2222, this.basicControl["clear-cache"]);
            if (!this.basicControlReboot && !this.basicControlShutdown) {
                this.basicControl.operation = "";
            }
            this.$esellApi.send("/group/attrbute/save.shtml", {
        ...
        // 保存
        saveCommit() {
            this.$esellApi.send("/group/timer/commit.shtml", {
        ...
        everyDayAdd() {
            ...
            console.log(111111111111, this.everyDayAddData["action-type"])
            this.$esellApi.send("/group/timer/save.shtml", {
                "attrbute-id": this.$route.query.id,//基本属性ID(父级ID)
        ...
        delete1(row) {
            ...
            this.$confirm('此操作将永久删除该记录, 是否继续?', '提示', {
                ...
                // 成功操作
                this.$esellApi.send("/group/timer/delete.shtml", {
                    id: row.id
                }, res => {
                    this.getDeviceRemoteControlSwitchList(this.timeSwitchType);
