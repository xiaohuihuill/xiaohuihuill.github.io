 <template>
    <div class="examine-device-group-list">
            ...
            <div class="content">
                <div class="slider cf" v-for="(item,index) in list" :key="index" :style="checked==index?deleteSlider:''">
                    <div @click="clickItem(item)" class="infor" @touchstart='touchStart($event,index)' @touchmove='touchMove' @touchend='touchEnd'>
                        <div class="infor_lfet" v-if="item.status=='ONL'">
                            <div>
                        ...
                        <div class="infor_lfet" v-else-if="item.status=='OFL'">
                            <div>
                        ...
                        <div class="infor_center">
                            <h5><span v-html="item.name?item.name:'——'"></span></h5>
                            ...
                            <div class="center_item">
                                <span>设备状态:</span>
                                <span v-html="item['status']=='ONL'?'在线':(item['status']=='OFL'?'离线':'未激活')"></span>
                            </div>
                        </div>
